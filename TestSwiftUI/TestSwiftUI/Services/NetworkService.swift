...
func loadFriendsID(token: String, completion: @escaping (Result<[Friend], Error>) -> Void) {
...
//    func loadNews(token: String, startTime: Date? = nil, completionHandler: @escaping ((Result<[News], Error>) -> Void)) {
//        let baseUrl = "https://api.vk.com"
//        let path = "/method/newsfeed.get"
